...
def send_to_kafka(settings: dict, data: dict):
    ...
    producer = prepare_producer(key="test",bootstrap_servers=["10.152.183.181:9094"], avro_schema_registry=f'http://10.152.183.242:8081', topic_name="topic2",value_schema=schema, num_partitions=1, replication_factor=1)
